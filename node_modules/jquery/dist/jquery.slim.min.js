...
!function(e, t) {
  ...
  !function() {
    ...
    function V(e) {
      ...
      return n != C && 9 === n.nodeType && n.documentElement && (r = (C = n).documentElement,
        ...
        F(function(e) {
          var t;
          r.appendChild(e).innerHTML = "<a id='" + k + "' href='' disabled='disabled'></a><select id='" + k
          ...
          preFilter: {
            ...
            PSEUDO: function(e) {
              ...
              return N.CHILD.test(e[0])
                ...
                : (e[3]
                  ? e[2] = e[4] || e[5] || ""
                  : n && A.test(n) && (t = Y(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length)
    ...
    function re(e, t, n, r) {
      ...
      if (n = n || [], 1 === c.length) {
        if (
          2 < (o = c[0] = c[0].slice(0)).length && "ID" === (a = o[0]).type && 9 === t.nodeType && T
          && x.relative[o[1].type]
        ) {
  ...
  ce.Deferred.exceptionHook = function(e, t) {
    ie.console && ie.console.warn && e && P.test(e.name)
  ...
  function Ve(e, t, n) {
    ...
    return (n = n || ze(e)) && (a = n.getPropertyValue(t) || n[t],
      ...
      !le.pixelBoxStyles() && $e.test(a) && Xe.test(t)
      && (r = u.width,
        i = u.minWidth,
        o = u.maxWidth,
  ...
  ce.extend({
    ...
    ce.each(["height", "width"], function(e, u) {
      ce.cssHooks[u] = {
        ...
        set: function(e, t, n) {
          ...
          return a && o
            && (s -= Math.ceil(
              e["offset" + u[0].toUpperCase() + u.slice(1)] - parseFloat(i[u]) - ot(e, u, "border", !1, i) - .5,
            )),
    ...
    ce.cssHooks.marginLeft = Qe(le.reliableMarginLeft, function(e, t) {
      if (t) {
        return (parseFloat(Ve(e, "marginLeft"))
    ...
    trigger: function(e, t, n, r) {
      ...
      if (
        o =
          ...
          n =
            n || m,
          3 !== n.nodeType && 8 !== n.nodeType && !gt.test(p + ce.event.triggered)
        ...
        return e.type = p,
          r || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(d.pop(), t) || !F(n)
          || u && v(n[p]) && !y(n)
            && ((a = n[u]) && (n[u] = null),
    ...
    ce.fn.extend({
      ...
      serializeArray: function() {
        return this.map(function() {
          ...
          var e = this.type;
          return this.name && !ce(this).is(":disabled") && wt.test(this.nodeName) && !xt.test(e)
