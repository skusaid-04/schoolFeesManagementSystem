...
!function(e, t) {
  ...
  ce.fn = ce.prototype = {
    ...
    ce.extend({
      ...
      each: function(e, t) {
        var n, r = 0;
        if (c(e)) { for (n = e.length; r < n; r++) if (!1 === t.call(e[r], r, e[r])) break; }
  ...
  !function() {
    var e,
      ...
      D = {
        ...
        PSEUDO: new RegExp("^" + g),
        CHILD: new RegExp(
          "^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(" + ge + "*(even|odd|(([+-]|)(\\d*)n|)" + ge
            + "*(?:([+-]|)" + ge + "*(\\d+)|))" + ge + "*\\)|)",
          "i",
        ),
        bool: new RegExp("^(?:" + f + ")$", "i"),
          ...
          preFilter: {
            ...
            PSEUDO: function(e) {
              ...
              return D.CHILD.test(e[0])
                ...
                : (e[3]
                  ? e[2] = e[4] || e[5] || ""
                  : n && j.test(n) && (t = Y(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length)
    ...
    function J(a, e, t) {
      ...
      return e.first
        ...
        : function(e, t, n) {
          var r, i, o = [E, f];
          if (n) { while (e = e[s]) if ((1 === e.nodeType || c) && a(e, t, n)) return !0; }
          else {while (e = e[s]) {
              if (1 === e.nodeType || c) {
    ...
    function re(e, t, n, r) {
      ...
      if (n = n || [], 1 === c.length) {
        if (
          2 < (o = c[0] = c[0].slice(0)).length && "ID" === (a = o[0]).type && 9 === t.nodeType && C
          && b.relative[o[1].type]
        ) {
  ...
  ce.fn.extend({
    ...
    index: function(e) {
      return e
        ? "string" == typeof e ? se.call(ce(e), this[0]) : se.call(this, e.jquery ? e[0] : e)
  ...
  function ot(e, t, n) {
    ...
    return (!le.boxSizingReliable() && i || !le.reliableTrDimensions() && fe(e, "tr") || "auto" === a
      ...
      && e.getClientRects().length && (i = "border-box" === ce.css(e, "boxSizing", !1, r), (o = s in e) && (a = e[s])),
    ...
    ce.each(["height", "width"], function(e, u) {
      ce.cssHooks[u] = {
        ...
        set: function(e, t, n) {
          ...
          return a && o
            && (s -= Math.ceil(
              e["offset" + u[0].toUpperCase() + u.slice(1)] - parseFloat(i[u]) - it(e, u, "border", !1, i) - .5,
            )),
    ...
    ce.cssHooks.marginLeft = Ye(le.reliableMarginLeft, function(e, t) {
      if (t) {
        return (parseFloat(Ge(e, "marginLeft"))
          || e.getBoundingClientRect().left - Ue(e, { marginLeft: 0 }, function() {
    ...
    for (
      !function(e, t) {
        ...
        for (n in e) {
          ...
          ) { for (n in o = a.expand(o), delete e[r], o) n in e || (e[n] = o[n], t[n] = i); } else t[r] = i;
        }
  ...
  ce.fn.extend({
    ...
    ce.extend({
      prop: function(e, t, n) {
        var r, i, o = e.nodeType;
        if (3 !== o && 8 !== o && 2 !== o) {
          return 1 === o && ce.isXMLDoc(e) || (t = ce.propFix[t] || t, i = ce.propHooks[t]),
            void 0 !== n
    ...
    val: function(n) {
      ...
      return arguments.length
        ? (i = v(n),
          this.each(function(e) {
            var t;
            1 === this.nodeType && (null == (t = i ? n.call(this, e, ce(this).val()) : n)
              ? t = ""
              : "number" == typeof t
              ? t += ""
        ...
        : t
        ? (r = ce.valHooks[t.type] || ce.valHooks[t.nodeName.toLowerCase()]) && "get" in r
    ...
    trigger: function(e, t, n, r) {
      ...
      if (
        o =
          ...
          n =
            n || C,
          3 !== n.nodeType && 8 !== n.nodeType && !Dt.test(d + ce.event.triggered)
        ...
        return e.type = d,
          r || e.isDefaultPrevented() || c._default && !1 !== c._default.apply(p.pop(), t) || !$(n)
          || u && v(n[d]) && !y(n)
            && ((a = n[u]) && (n[u] = null),
    ...
    ce.fn.extend({
      ...
      serializeArray: function() {
        return this.map(function() {
          ...
          var e = this.type;
          return this.name && !ce(this).is(":disabled") && Ot.test(this.nodeName) && !Ht.test(e)
  ...
  le.cors = !!Qt && "withCredentials" in Qt,
    ...
    ce.ajaxTransport("script", function(n) {
      ...
      if (n.crossDomain || n.scriptAttrs) {
        return {
          send: function(e, t) {
            r = ce("<script>").attr(n.scriptAttrs || {}).prop({ charset: n.scriptCharset, src: n.url }).on(
              "load error",
              i = function(e) {
  ...
  ce.ajaxSetup({
    ...
    ce.fn.load = function(e, t, n) {
      ...
      return -1 < s && (r = Tt(e.slice(s)), e = e.slice(0, s)),
        ...
        0 < a.length && ce.ajax({ url: e, type: i || "GET", dataType: "html", data: t }).done(function(e) {
